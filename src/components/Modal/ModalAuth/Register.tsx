    ...
    return (
        <>
            <div className="">
                ...
                <h1 className="text-[#292929] text-center mt-5 dark:text-slate-200 text-4xl font-bold">Đăng ký với Pinterest</h1>
            </div>
            <div className="mt-11">
            ...
            <div className=" mt-11">
                <p className="text-base text-center">
                    ...
                    <span onClick={handleNavigateRegister} className="font-semibold cursor-pointer text-primary hover:text-primary_hover active:text-primary_active">
                        Đăng nhập
                    </span>
                </p>
            </div>
